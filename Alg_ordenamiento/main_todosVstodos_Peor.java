 ...
 * @author Haide
 */
public class main_todosVstodos_Peor {
    ...
    public static void main(String[] args) {
        ...
        for (int j = 0; j < n; j++){
            ...
            aux3 = GeneradorDatos.ordenarDesc(arr_c3);//peor caso
            aux4 = GeneradorDatos.ordenarDesc(arr_c4);//peor caso
            aux5 = GeneradorDatos.ordenarDesc(arr_c5);//peor caso
